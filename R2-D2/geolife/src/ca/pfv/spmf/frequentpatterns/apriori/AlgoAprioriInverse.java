...
public class AlgoAprioriInverse {
	...
	protected Itemsets perfectlyRareItemsets = new Itemsets(
	...
	protected List<ItemsetApriori> createLevelWithRareCandidates(double minsup,
			double maxsup, List<ItemsetApriori> candidatesK) {
	...
	public void printStats() {
		...
		System.out.println(" Perfectly rare itemsets count : "
				+ perfectlyRareItemsets.getItemsetsCount());
