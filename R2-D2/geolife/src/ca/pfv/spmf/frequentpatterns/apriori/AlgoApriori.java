...
/**
 * This is an implementation of the Apriori algorithm based on :
 * 
...
public class AlgoApriori {
	...
	/**
	 * Add the empty set to level 0 if no itemset of level 1 have a support that
	 * is equal to the number of transactions in the binary context.
	 * 
	 * @param candidatesSize1
	 *            Candidates of level 1.
	 */
