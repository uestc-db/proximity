...
/**
 * This class is for representing an association rule that has been found by
 * IGB. An association rule has an antecedent, a consequent, a support and a
 * confidence.
 * 
...
public class RuleMNR {
	...
	public RuleMNR(ItemsetZart itemset1, ItemsetZart itemset2,
