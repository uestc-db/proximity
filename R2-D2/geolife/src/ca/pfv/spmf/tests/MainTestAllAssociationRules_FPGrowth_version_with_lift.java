 ...
 */
public class MainTestAllAssociationRules_FPGrowth_version_with_lift {
	...
	public static void main(String [] arg){
		...
		double  minlift = 0.2;
		double  minconf = 0.50;
		AlgoAgrawalFaster94_FPGrowth_version algoAgrawal = new AlgoAgrawalFaster94_FPGrowth_version(minconf, minlift);
		RulesAgrawal rules = algoAgrawal.runAlgorithm(patterns);
		rules.printRulesWithLift(database.size());
	}
	
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAllAssociationRules_FPGrowth_version_with_lift.class.getResource(filename);
