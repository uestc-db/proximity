...
import ca.pfv.spmf.associationrules.fhsar_saveToFile.AlgoFHSAR;

/**
 * Class to test the  FHSAR algorithm.
...
public class MainTestFHSAR {
	...
	public static void main(String [] arg) throws IOException{
		...
		String output = "C://new_database.txt";  // the path for saving the transformed database
		double minsup = 0.5;
		double  minconf = 0.60;
